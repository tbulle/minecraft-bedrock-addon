...
tellraw @s {"rawtext":[{"text":"§b[Lightsaber] §6To activate: Hold lightsaber and CROUCH for 1 second!"}]}
tellraw @s {"rawtext":[{"text":"§b[Lightsaber] §6Alternative: Run §e/function lightsaber/toggle"}]}
